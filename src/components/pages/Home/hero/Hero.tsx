...
export default function Hero() {
    return (
        ...
        >
            ...
            <Container className="relative pt-18 sm:pt-24 md:pt-36 2xl:pt-56.25 2xl:pb-20">
                {/* text and btn  */}
                <div className="mx-auto max-w-240 text-center relative">
                    ...
                    {/* text content */}
                    <h1 className="text-[22px] sm:text-[40px] 2xl:text-[70px] font-bold leading-[1.3] md:leading-[1.2] md:tracking-[-0.01px]">
                        Operational{" "}
                    ...
                    <p className="mx-auto mt-3 md:mt-7.5 max-w-224.5 leading-[1.4] md:leading-[1.6] tracking-normal text-muted-foreground-primary font-normal text-xs sm:text-base lg:text-lg">
                        {heroData.description}
                    </p>
                    {/* buttons */}
                    <div className="mt-6 md:mt-8 flex flex-col sm:flex-row items-center justify-center gap-2 md:gap-3">
                        <a href={"/"}>
                ...
                <div className="mt-16 2xl:mt-32 flex flex-wrap items-center justify-center gap-6">
